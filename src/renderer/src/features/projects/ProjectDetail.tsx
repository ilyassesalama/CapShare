...
export function ProjectDetail({ project, onClose }: ProjectDetailProps): JSX.Element {
  return (
    ...
    <DetailDialog key={project?.folderPath ?? 'none'} project={project} onClose={onClose} />
  )
}

function DetailDialog({ project, onClose }: ProjectDetailProps): JSX.Element {
  ...
  return (
    <Dialog open={project !== null} onOpenChange={(open) => !open && !exporting && onClose()}>
      <DialogContent
          ...
          <>
            ...
            <div className="flex flex-col gap-5 p-5">
              ...
              {phase.state === 'done' ? (
                ...
                <div className="glass-subtle flex flex-col gap-3 rounded-2xl p-4">
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-2.5">
                    ...
                    <Label
                      ...
                      className="cursor-pointer text-[12px] leading-tight text-muted-foreground"
                    >
                      Include AI caches
                  ...
                  <Button onClick={() => void startExport()} className="rounded-full px-5">
